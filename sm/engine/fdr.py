...
class FDR(object):
    ...
    def estimate_fdr(self, msm_df):
        # TODO change FDR calculation from one ta at a time to all at once
        # instead of sampling one decoy 20 times, why not just choose one random decoy per sf+target?
